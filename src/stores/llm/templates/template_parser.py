...
class TemplateParser:
    ...
    def set_language(self, language: str): # 3ashan aghayar during el runtime
        if not language:
    ...
    def get(self, group: str, key: str, vars: dict={}):
        ...
        # import group module through runtime 
        module = __import__(f"stores.llm.templates.locales.{targeted_language}.{group}", fromlist=[group])

        if not module:
            return None 
        
        key_attribute = getattr(module, key) # system, document or footer prompt
